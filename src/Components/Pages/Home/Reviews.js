...
const Reviews = () => {
    ...
    const { data: reviews, isLoading } = useQuery('reviews', () => fetch('https://dry-escarpment-82110.herokuapp.com/allreview').then(res => res.json()))
                                ...
                                <>
                                    <div className="group w-full bg-white relative flex flex-col items-center hover:bg-secondary cursor-pointer shadow-md md:p-12 p-6">
                                        ...
                                        <div className="text-gray-600 group-hover:text-white flex flex-col items-center">
                                            ...
                                            <p className="xl:w-80 text-base font-semibold leading-normal text-center mt-4">{review.description}</p>
                                        </div>
                                        ...
                                        <div className="flex flex-col items-center justify-center mt-10">
                                            <p className="text-base font-semibold leading-4 my-2 text-gray-800">Rating : {review.rating} </p>
                                            <h3 className="text-xl font-semibold leading-4 my-2 text-gray-800">{review.name}</h3>
                                        </div>
